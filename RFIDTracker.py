...
'''TickableRFIDTracker is a dumb variant on the original threaded version
which removes a lot of the complexity and generally works better'''
class TickableRFIDTracker():
    def __init__(self):
        '''init'''
        self.rfidReader = MFRC522.MFRC522()  
	print "Starting RFID Reader"
